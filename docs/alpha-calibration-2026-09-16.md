...
**First pilot (protocol schema 1), superseded during PR review:** the data generator
and bootstrap reused the same seed. The tables below are retained as historical
instrument evidence, not an approved error-rate estimate. Schema 2 spawns four
...
still share innovations intentionally. A corrected run is required before final
reporting; the correction changes no promotion gate.

Executed the actual CLI on clean source `ffa0d3b` in an isolated worktree, Python
...
- Private artifact: `calibration-20260916/report.json` in the research state directory.
- Artifact SHA256: `a3c6fe0a769343e9409947b4e7dd7b0e3ae3aa0718899ecb0fa33ad5c8aaf745`.
...
32/32 and 31/32 respectively. The weaker sparse control also failed the minimum
holdout trade count in 30/32. The single dense-positive failure was holdout DSR.
...
| --- | --- | --- | --- |
| 0 | Null: any candidate rejected | 3/32 | 3.2–24.2% |
| 0 | Alternative: planted candidate detected | 26/32 | 64.7–91.1% |
| 0.5 | Null: any candidate rejected | 4/32 | 5.0–28.1% |
| 0.5 | Alternative: planted candidate detected | 9/32 | 15.6–45.4% |
